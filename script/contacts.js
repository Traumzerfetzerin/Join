        ...
        .then(exists => {
            ...
            saveContactData(name, email, phone)
                .then(newContactId => {
                    ...
                    // Reload contacts and directly open the new contact's details
                    loadContacts();
                    setTimeout(() => {
                        showContactDetails(newContactId); // Show the newly created contact in the overlay
                    }, 500); // Adding a slight delay to ensure contacts are loaded before showing details
                })
                .catch(error => {
...
async function saveContactData(name, email, phone) {
    ...
    return data.name; // Return the new contact's ID generated by Firebase
}
